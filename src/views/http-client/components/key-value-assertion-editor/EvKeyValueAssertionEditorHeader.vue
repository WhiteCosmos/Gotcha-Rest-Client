<template>
    <div class="ev-key-value-assertion-editor-header">
        ...
        <div class="ev-key-value-assertion-editor__name-column">
            <ev-label size="11" bold secondary>{{ options.headers[0] }}</ev-label>
        </div>

        <div class="ev-key-value-assertion-editor__condition-column">
            <!--            <ev-label size="11" bold secondary>Condition</ev-label>-->
        </div>

        <div class="ev-key-value-assertion-editor__value-column">
            <ev-label size="11" bold secondary>{{ options.headers[1] }}</ev-label>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        name: "EvKeyValueAssertionEditorHeader",
...
<style lang="scss" scoped>
    ...
    .ev-key-value-assertion-editor-header {
        display: flex;
