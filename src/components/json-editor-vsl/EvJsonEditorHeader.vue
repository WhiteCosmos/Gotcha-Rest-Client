<template>
    <div class="ev-json-editor-header">
        <div class="ev-json-editor__json-node__key">
            <div class="ev-json-editor__json-node__widget" @click="doToggleExpandAll">
        ...
        <div class="ev-json-editor__json-node__value">
            ...
            <div class="ev-json-editor-header__label-container" v-if="isCopingOrMoving">
                <span class="ev-json-editor-header__label">{{ message }}</span>
            </div>
        </div>
    </div>
</template>
...
<style lang="scss" scoped>
    ...
    .ev-json-editor-header {
        ...
        padding-right: 18px; // 4 + 16 算上Scroll的宽度
